...
const EditBookingPage = () => {
    ...
    const archeiveBooking = async (bookingId) => {
        if (!window.confirm('Are you sure you want to Archeive this booking?')) {
        ...
        try {
            ...
            if (response.statusCode === 200) {
                setSuccessMessage("The booking was Successfully Archeived")
        ...
        {bookingDetails && (
          <div className="booking-details">
            ...
            <button
              ...
              onClick={() => archeiveBooking(bookingDetails.id)}
            >
              <FontAwesomeIcon
                icon={faArchive}
